...
There are less sedentary minutes on Saturday. This day overtakes in other types, except for being a bit less in terms of lightly active minutes. But this still cannot explain the difference in total amount of burnt calories. Let's see if the same picture happens for the mean numbers.
...
For the presentation, we will need several dataframes.
